...
const advancedControls = [
    ...
    { tab: 'advanced', target: 'styles', section: 'Layout', name: 'overflow', type: 'select', label: 'Overflow', options: [{ value: 'visible', label: 'Visible' }, { value: 'hidden', label: 'Hidden' }, { value: 'auto', label: 'Auto' }, { value: 'scroll', label: 'Scroll' }, { value: 'clip', label: 'Clip' }], default: 'visible', responsive: true },
    ...
    { tab: 'advanced', target: 'styles', section: 'Transform', name: 'transform', type: 'text', label: 'Custom transform', placeholder: 'skew(8deg, 0deg)', responsive: true, states: true },
    ...
    { tab: 'advanced', target: 'styles', section: 'Transform', name: 'transform-style', type: 'choose', label: '3D children', options: [{ value: 'flat', label: 'Flat' }, { value: 'preserve-3d', label: 'Preserve 3D' }], states: true },
            { tab: 'advanced', target: 'styles', section: 'Flex item', name: 'align-self', type: 'select', label: 'Align self', options: [{ value: 'auto', label: 'Auto' }, { value: 'stretch', label: 'Stretch' }, { value: 'flex-start', label: 'Start' }, { value: 'center', label: 'Center' }, { value: 'flex-end', label: 'End' }], default: 'auto', responsive: true },
            { tab: 'advanced', target: 'styles', section: 'Flex item', name: 'order', type: 'number', label: 'Order', default: 0, responsive: true },
            { tab: 'advanced', target: 'styles', section: 'Flex item', name: 'flex-grow', type: 'number', label: 'Grow', default: 0, responsive: true },
            { tab: 'advanced', target: 'styles', section: 'Flex item', name: 'flex-shrink', type: 'number', label: 'Shrink', default: 1, responsive: true },
    { tab: 'advanced', target: 'styles', section: 'Effects', name: 'opacity', type: 'slider', label: 'Opacity', min: 0, max: 1, step: 0.05, scale: 100, suffix: '%', default: 1, responsive: true, states: true },
    { tab: 'advanced', target: 'styles', section: 'Effects', name: 'filter', type: 'css-filters', label: 'Filters' },
...
const typographyControls = {
    tab: 'style', target: 'styles', section: 'Typography', name: 'typography', type: 'typography', label: 'Style',
};
...
export default function registerInkFoundationElements(registry) {
    ...
    registry.register({
        ...
        controls: [
            ...
            { tab: 'content', section: 'Content', name: 'size', type: 'choose', label: 'Size', options: [{ value: '', label: 'Base', title: 'No size override' }, { value: 'small', label: 'S', title: 'Small' }, { value: 'medium', label: 'M', title: 'Medium' }, { value: 'large', label: 'L', title: 'Large' }, { value: 'xl', label: 'XL', title: 'Extra large' }, { value: 'xxl', label: '2XL', title: 'Double extra large' }] },
            ...
            { tab: 'style', target: 'styles', section: 'Typography', name: 'link-color', type: 'color', label: 'Link color', states: true, property: 'color', part: 'link' },
            ...advancedControls,
    ...
    registry.register({
        ...
        controls: [
            ...
            { tab: 'style', target: 'styles', section: 'Image', name: 'filter', type: 'css-filters', label: 'Filters', states: true, part: 'image' },
