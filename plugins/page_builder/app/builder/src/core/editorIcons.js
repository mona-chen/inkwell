...
const aliases = {
    ...
    extension: 'puzzle', featured_play_list: 'panels-top-left', format_align_center: 'align-center', format_align_justify: 'align-justify', format_align_left: 'align-left', format_align_right: 'align-right',
    ...
    horizontal_rule: 'minus', html: 'file-code-2', image: 'image', info: 'info', input: 'text-cursor-input', keyboard_return: 'corner-down-left', label: 'tag', language: 'globe-2',
    ...
    subject: 'align-left', tab: 'panel-top', tablet: 'tablet', text_fields: 'type', title: 'heading', toggle_on: 'toggle-right', touch_app: 'mouse-pointer-click', tune: 'sliders-horizontal',
