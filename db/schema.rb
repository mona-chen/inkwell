...
ActiveRecord::Schema[8.1].define(version: 2026_09_09_060000) do
  ...
  create_table "builder_workspaces", force: :cascade do |t|
    ...
    t.jsonb "threads", default: [], null: false
    t.datetime "updated_at", null: false
    t.index ["site_id", "record_type", "record_id"], name: "index_builder_workspaces_on_record", unique: true
    t.index ["site_id"], name: "index_builder_workspaces_on_site_id"
  end
